...
urlpatterns = [     
    ...
    url(r'^acc_panelesdatagrupo', views.acc_panelesdatagrupo),
    url(r'^acc_panelesdata', views.acc_panelesdata),
    url(r'^acc_paneles', views.acc_paneles),
    ...
    url(r'^sri_cedula', views.sri_cedula),
    url(r'^CondicionesTraer', views.CondicionesTraer),
    url(r'^CondicionesDetalleXCondicionesTraer', views.CondicionesDetalleXCondicionesTraer),
    url(r'^CondicionesDetalleXCondicionesGuardar', views.CondicionesDetalleXCondicionesGuardar),
    url(r'^CondicionesDetalleXCondicionesEliminar', views.CondicionesDetalleXCondicionesEliminar),
    url(r'^sri_103', views.sri_103),
    url(r'^sri_104', views.sri_104),
    url(r'^sri_descarga', views.sri_descarga),

...
function armar_t_dataCampostr(fuente, t_pkestructura, tem_pestalla ){
  ...
  if(fuente =='cmpcondicional'){  
    ...
    for (var i = 1; i < formulavalores.children[0].children[0].childElementCount; i++) {
      ...
      if(formulavalores.children[0].children[0].children[i].children[1].children[0].value == 'Igual Texto'){val_internos['Operador'] = 'igual'}
      if(formulavalores.children[0].children[0].children[i].children[1].children[0].value == 'Igual Numero'){val_internos['Operador'] = '='}
      if(formulavalores.children[0].children[0].children[i].children[1].children[0].value == 'Distinto'){val_internos['Operador'] = '!='}
      if(formulavalores.children[0].children[0].children[i].children[1].children[0].value == 'Mayor'){val_internos['Operador'] = '>'}
      if(formulavalores.children[0].children[0].children[i].children[1].children[0].value == 'Menor'){val_internos['Operador'] = '<'}
      if(formulavalores.children[0].children[0].children[i].children[1].children[0].value == 'Mayor Igual'){val_internos['Operador'] = '>='}
      if(formulavalores.children[0].children[0].children[i].children[1].children[0].value == 'Menor igual'){val_internos['Operador'] = '<='}
...
function cmpopcion_add_fila(){
  ...
  new_fila = new_fila  + '<option selected style="background: '+CSS_COLOR_NAMES[0]+';">'+CSS_COLOR_NAMES[0]+'</option>'

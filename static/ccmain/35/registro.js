...
function registro_sin_server(pkmodulo, pkregistro, tipo, temp_pestalla, origen, t_clave, respuesta_previa, datos_cabecera, datos_detalle) {
...
function registro(pkmodulo, pkregistro, tipo, temp_pestalla, origen, t_clave) {
    if (bloqueado() == true) {
      document.getElementById('a_default_pagos').click()
      return
    }
...
function regitro_resp(Response, tipo, pestalla, pkmodulo, pkregistro, origen, t_clave){

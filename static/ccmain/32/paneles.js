                    ...
                    if (int_campos.indexOf(para_label) != -1) {
                      if (nom_tex.length == 1) {
                        ...
                        if (nom_tex[1].substring(nom_tex[1].length - 1) == 'x') {     //filefilefilefilefile
                          ...
                          html_temp = html_temp  + '<img style="width: 100%;height: 60%;margin-left: auto;margin-right: auto; display: block;" src="https://www.cerocodigo.com/media/archivos/' + web_Id_empresa + '/' + Response["dbgrupos"][x]['vals'][x2][Object.keys(Response["dbgrupos"][x]['vals'][x2])[x3]] + '" alt="image" value="https://www.cerocodigo.com/media/archivos/' + web_Id_empresa + '/' + Response["dbgrupos"][x]['vals'][x2][Object.keys(Response["dbgrupos"][x]['vals'][x2])[x3]] + '">'
